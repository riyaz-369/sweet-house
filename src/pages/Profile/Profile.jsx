    ...
    return (
        <div className="max-w-7xl mx-auto my-12 flex justify-end">
            <div className="p-6 min-w-[500px] shadow-md rounded-md sm:px-12">
                <img src={user.photoURL} alt="" className="w-32 mx-auto rounded-full aspect-square ring-4 ring-blue-600 ring-offset-2" />
                <div className="space-y-4 mt-6 text-center">
                    ...
                    <Link to="/update-profile">
                        <button className="btn btn-sm bg-blue-600 hover:bg-blue-700 text-white">Update Profile</button>
                    </Link>
                </div>
            </div>
        </div>
