    ...
    return (
        <div>
            <Swiper
                ...
                {/* slide 1 */}
                <SwiperSlide>
                    <div className="rounded-3xl lg:h-[550px]" style={{ backgroundImage: `url(${beautifulHouse})` }}>
                        <div className="rounded-3xl bg-gradient-to-r from-[#030712] to-60% h-full">
                            <div>
                                <div className="flex p-32">
                                    <div>
                                        ...
                                        <button className="btn btn-outline hover:bg-white hover:text-black bg-warning text-base border-none px-7">Contact us</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                {/* slide 2 */}
                <SwiperSlide>
                    <div className="rounded-3xl lg:h-[550px]" style={{ backgroundImage: `url(${family})` }}>
                        <div className="rounded-3xl bg-gradient-to-r from-[#030712] to-60% h-full">
                            <div>
                                <div className="flex p-32">
                                    <div>
                ...
                {/* slide 3 */}
                <SwiperSlide>
                    <div className="rounded-3xl lg:h-[550px]" style={{ backgroundImage: `url(${studentHouse})` }}>
                        <div className="rounded-3xl bg-gradient-to-r from-[#030712] to-60% h-full">
                            <div>
                                <div className="flex p-32">
                                    <div>
